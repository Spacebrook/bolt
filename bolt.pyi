...
class Config:
    def __init__(self, pool_size: int, node_capacity: int, max_depth: int, min_size: Optional[float] = None, looseness: Optional[float] = None, large_entity_threshold_factor: Optional[float] = None) -> None: ...
